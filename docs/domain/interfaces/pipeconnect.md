---
module: pipeconnect-interfaces
---
# Интерфейсы PipeConnect

> Загружать: при реализации или вызове сервисов PipeConnect.
