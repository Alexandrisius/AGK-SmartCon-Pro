...
| Документ | Описание | Когда загружать |
|---|---|---|
| [`invariants.md`](invariants.md) | Жёсткие правила I-01..I-16. Нарушение = баг. | **ВСЕГДА** |
...
| SmartCon.Tests | ✅ 841 тестов, 0 ошибок | Unit + ViewModel тесты (xUnit + Moq) |
...
**Phase 13 (FamilyManager Published Storage) завершена (2026-05-01):** ADR-015, ADR-016, Published Storage, Asset management, Category tree.
