...
> **Версия:** 1.4.4 (см. `Version.txt`) | **Платформа:** Revit 2019-2026 / .NET Framework 4.8 + .NET 8 / C# 12 / WPF
...
| SmartCon.FamilyManager | ✅ Реализован | FamilyManager MVP: dockable panel, SQLite catalog, ADR-014 |
| SmartCon.Tests | ✅ 716 тестов, 0 ошибок | Unit + ViewModel тесты (xUnit + Moq) |
