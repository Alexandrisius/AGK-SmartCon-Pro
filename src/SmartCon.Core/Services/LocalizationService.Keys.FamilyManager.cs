...
ru["FM_Cloud_LoginModeHeader_Login"] = "Вход в аккаунт";
        ...
        ru["FM_Cloud_CatalogGone"] = "Каталог «{1}» снят с публикации автором — обновления базы «{0}» недоступны, копия больше не обновляется";
        en["FM_Cloud_CatalogGone"] = "Catalog '{1}' was unpublished by its author — updates for database '{0}' are unavailable, the copy no longer updates";
        ...
        ru["FM_Cloud_PullDone"] = "Обновлено до публикации #{0}: {1} семейств.";
        en["FM_Cloud_PullDone"] = "Updated to publication #{0}: {1} items.";
