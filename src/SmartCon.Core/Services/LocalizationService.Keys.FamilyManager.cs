...
public static partial class LocalizationService
{
    private static void AddFamilyManagerKeys(Dictionary<string, string> ru, Dictionary<string, string> en)
    {
        ...
        ru["FM_Diff_Section_META"] = "Метаданные (формат, категория)"; en["FM_Diff_Section_META"] = "Metadata (format, category)";
        ru["FM_Diff_Section_PARAMS"] = "Структура параметров"; en["FM_Diff_Section_PARAMS"] = "Parameter structure";
        ru["FM_Diff_Section_TYPES"] = "Типоразмеры и их значения"; en["FM_Diff_Section_TYPES"] = "Types and their values";
        ru["FM_Diff_Section_PHANTOM"] = "Фантомные типы"; en["FM_Diff_Section_PHANTOM"] = "Phantom types";
        ru["FM_Diff_Section_DEF"] = "Привязки параметров (видимость, материал, размеры)"; en["FM_Diff_Section_DEF"] = "Parameter bindings (visibility, material, dimensions)";
        ru["FM_Diff_Section_GEOM"] = "3D-геометрия"; en["FM_Diff_Section_GEOM"] = "3D geometry";
        ru["FM_Diff_Section_GEOM2D"] = "2D-графика (условные обозначения)"; en["FM_Diff_Section_GEOM2D"] = "2D graphics (symbolic)";
        ru["FM_Diff_Section_NESTED"] = "Вложенные семейства"; en["FM_Diff_Section_NESTED"] = "Nested families";
        ru["FM_Diff_Section_NONSHARED"] = "Необщие вложенные семейства"; en["FM_Diff_Section_NONSHARED"] = "Non-shared nested families";
        ru["FM_Diff_Section_NESTEDHASH"] = "Содержимое вложенных семейств"; en["FM_Diff_Section_NESTEDHASH"] = "Nested family content";
        ru["FM_Diff_Section_FACTS"] = "Факты семейства (Part Type)"; en["FM_Diff_Section_FACTS"] = "Family facts (Part Type)";
        ru["FM_Diff_Section_FLAGS"] = "Флаги семейства"; en["FM_Diff_Section_FLAGS"] = "Family flags";
        ru["FM_Diff_Section_CONN"] = "Коннекторы"; en["FM_Diff_Section_CONN"] = "Connectors";
        ru["FM_Diff_Section_LOOKUP"] = "Lookup-таблицы"; en["FM_Diff_Section_LOOKUP"] = "Lookup tables";
        ru["FM_Diff_Section_FAMKEY"] = "Ключ семейства"; en["FM_Diff_Section_FAMKEY"] = "Family key";
        ru["FM_Diff_Section_STRUCT"] = "Структура (слои)"; en["FM_Diff_Section_STRUCT"] = "Structure (layers)";
        ru["FM_Diff_Section_ROUTING"] = "Маршрутизация (правила)"; en["FM_Diff_Section_ROUTING"] = "Routing rules";
        ru["FM_Diff_Section_SEGMENTS"] = "Сегменты и материалы"; en["FM_Diff_Section_SEGMENTS"] = "Segments and materials";
        ru["FM_Diff_Section_SUBTYPES"] = "Подтипы"; en["FM_Diff_Section_SUBTYPES"] = "Subtypes";
        ru["FM_Diff_Section_RAILING"] = "Ограждение (структура)"; en["FM_Diff_Section_RAILING"] = "Railing structure";
        ru["FM_Diff_Section_WIRE"] = "Провод (параметры)"; en["FM_Diff_Section_WIRE"] = "Wire settings";
        ...
        ru["FM_Tab_Routing"] = "Трассировка"; en["FM_Tab_Routing"] = "Routing";
        ru["FM_Routing_Type"] = "Тип"; en["FM_Routing_Type"] = "Type";
        ru["FM_Routing_PreferredJunction"] = "Предпочтительный тип соединения"; en["FM_Routing_PreferredJunction"] = "Preferred junction type";
        ...
        ru["FM_Routing_PartNotInCatalog"] = "Нет в каталоге — импортируйте .rfa этого семейства"; en["FM_Routing_PartNotInCatalog"] = "Not in the catalog — import this family's .rfa";
        ru["FM_Routing_NoCandidates"] = "В каталоге нет фитингов этой категории и типа детали. Импортируйте .rfa файловым импортом."; en["FM_Routing_NoCandidates"] = "No fittings of this category and part type in the catalog. Import .rfa files via file import.";
        ru["FM_Routing_Picker_Title"] = "Выбор детали трассировки"; en["FM_Routing_Picker_Title"] = "Select routing part";
        ...
        ru["FM_BatchImport_OutdatedNested_Tooltip"] = "Вложенное «{0}» зашито устаревшей версией (зашита {1}, активна {2}). Импорт родителя заблокирован: обновите вложенное семейство внутри родителя и повторите импорт — или выберите «Сделать активной» на строке вложенного, чтобы каталог вернулся на зашитую версию."; en["FM_BatchImport_OutdatedNested_Tooltip"] = "Nested \"{0}\" embeds an outdated version (embedded {1}, active {2}). The parent's import is blocked: update the nested family inside the parent and re-import — or pick \"Make Active\" on the nested row to switch the catalog back to the embedded version.";
        ...
        ru["FM_DependencyDriftBlock_Item"] = "• {0} — зашита {1}, активна {2}"; en["FM_DependencyDriftBlock_Item"] = "• {0} — embedded {1}, active {2}";
        ru["FM_DependencyDriftBlock_Status"] = "Загрузка \"{0}\" заблокирована: устаревшие вложенные семейства"; en["FM_DependencyDriftBlock_Status"] = "Load of \"{0}\" blocked: outdated nested families";
        ...
        ru["FM_AssignEditor_CopyParent"] = "Копировать условия предка"; en["FM_AssignEditor_CopyParent"] = "Copy ancestor rules";
        ru["FM_AssignEditor_CopyParentTooltip"] = "Копирует правила ближайшей категории-предка с настроенными правилами («{0}») как отправную точку. Если у родителя правил нет — берутся из более старшей категории. После копирования правила полностью независимы."; en["FM_AssignEditor_CopyParentTooltip"] = "Copies the rules of the nearest ancestor category with configured rules ('{0}') as a starting point. If the direct parent has none, rules come from a higher ancestor. Afterwards they are fully independent.";
        ...
        ru["FM_AdvSearch_Title"] = "Расширенный поиск"; en["FM_AdvSearch_Title"] = "Advanced Search";
        ru["FM_AdvSearch_Subtitle"] = "Условия объединяются по «И» и дополняют обычный поиск по названию. Список атрибутов зависит от выбранной категории."; en["FM_AdvSearch_Subtitle"] = "Conditions are combined with AND and refine the plain name search. The attribute list depends on the selected category.";
        ru["FM_AdvSearch_Category"] = "Категория"; en["FM_AdvSearch_Category"] = "Category";
        ru["FM_AdvSearch_AllCategories"] = "Все категории"; en["FM_AdvSearch_AllCategories"] = "All categories";
        ru["FM_AdvSearch_ColOperator"] = "Условие"; en["FM_AdvSearch_ColOperator"] = "Condition";
        ru["FM_AdvSearch_And"] = "И"; en["FM_AdvSearch_And"] = "AND";
        ru["FM_AdvSearch_AddCondition"] = "Добавить условие"; en["FM_AdvSearch_AddCondition"] = "Add condition";
        ru["FM_AdvSearch_Empty"] = "Условий пока нет — нажмите «Добавить условие», чтобы сузить выдачу дерева."; en["FM_AdvSearch_Empty"] = "No conditions yet — click 'Add condition' to narrow the tree.";
        ru["FM_AdvSearch_Apply"] = "Применить"; en["FM_AdvSearch_Apply"] = "Apply";
        ru["FM_AdvSearch_ApplyIncomplete"] = "Заполните все условия: незаполненные обязательные поля обведены красной рамкой"; en["FM_AdvSearch_ApplyIncomplete"] = "Complete every condition: required empty fields are outlined in red";
        ru["FM_AdvSearch_Reset"] = "Сбросить"; en["FM_AdvSearch_Reset"] = "Reset";
        ru["FM_SearchOp_HasValue"] = "Заполнено"; en["FM_SearchOp_HasValue"] = "Is filled";
        ru["FM_SearchOp_IsEmpty"] = "Не заполнено"; en["FM_SearchOp_IsEmpty"] = "Is not filled";
        ru["FM_AdvSearch_OpenTooltip"] = "Расширенный поиск по атрибутам"; en["FM_AdvSearch_OpenTooltip"] = "Advanced search by attributes";
        ru["FM_AdvSearch_ActiveTooltipFormat"] = "Активных условий: {0} — нажмите, чтобы изменить или сбросить"; en["FM_AdvSearch_ActiveTooltipFormat"] = "Active conditions: {0} — click to change or reset";
        ru["FM_AdvSearch_CategoryOnlyTooltip"] = "Фильтр по категории активен — нажмите, чтобы изменить или сбросить"; en["FM_AdvSearch_CategoryOnlyTooltip"] = "Category filter is active — click to change or reset";
        ru["FM_AdvSearch_PickCategoryTooltip"] = "Выбрать категорию из дерева каталога"; en["FM_AdvSearch_PickCategoryTooltip"] = "Pick a category from the catalog tree";
        ru["FM_AdvSearch_SuggestionsTooltip"] = "Сохранённые значения атрибута"; en["FM_AdvSearch_SuggestionsTooltip"] = "Stored values of the attribute";
        ru["FM_AdvSearch_NoSuggestions"] = "Нет сохранённых значений — введите текст вручную"; en["FM_AdvSearch_NoSuggestions"] = "No stored values — type your own";
        ru["FM_NoResultsPlaceholder"] = "Ничего не найдено — измените поисковый запрос или сбросьте фильтр расширенного поиска"; en["FM_NoResultsPlaceholder"] = "Nothing found — change the search text or reset the advanced filter";
        ru["FM_EmptyCatalogPlaceholder"] = "В каталоге нет ни одного семейства"; en["FM_EmptyCatalogPlaceholder"] = "The catalog has no families";
        ru["FM_ItemCountTooltipFormat"] = "Показано семейств: {0} из {1} в каталоге"; en["FM_ItemCountTooltipFormat"] = "Showing {0} of {1} families in the catalog";
...
ru["FM_ProfileCloudTitle"] = "Облачный аккаунт";
        en["FM_ProfileCloudTitle"] = "Cloud account";
        ru["FM_ProfileCloudSignIn"] = "Войти";
        en["FM_ProfileCloudSignIn"] = "Sign in";
        ru["FM_ProfileCloudSignOut"] = "Выйти";
        en["FM_ProfileCloudSignOut"] = "Sign out";
        ru["FM_ProfileCloudNone"] = "Вход не выполнен";
        en["FM_ProfileCloudNone"] = "Not signed in";
        ru["FM_ProfileCloudServer"] = "Сервер: {0}";
        en["FM_ProfileCloudServer"] = "Server: {0}";
        ru["FM_ProfileCloudSignOutConfirm"] = "Выйти из облачного аккаунта? Подписки и локальные копии сохранятся.";
        en["FM_ProfileCloudSignOutConfirm"] = "Sign out of the cloud account? Subscriptions and local copies are kept.";
        ru["FM_Cloud_LoginEndpoint"] = "Сервер";
        en["FM_Cloud_LoginEndpoint"] = "Server";
        ru["FM_Cloud_LoginEndpointPlaceholder"] = "https://… (адрес сервера)";
        en["FM_Cloud_LoginEndpointPlaceholder"] = "https://… (server address)";
        ru["FM_Cloud_LoginEmail"] = "Email";
        en["FM_Cloud_LoginEmail"] = "Email";
        ru["FM_Cloud_LoginPassword"] = "Пароль";
        en["FM_Cloud_LoginPassword"] = "Password";
        ru["FM_Cloud_LoginDisplayName"] = "Отображаемое имя";
        en["FM_Cloud_LoginDisplayName"] = "Display name";
        ru["FM_Cloud_LoginModeToggle_Register"] = "Создать новый аккаунт";
...
ru["FM_Cloud_LoginModeHeader_Login"] = "Вход в аккаунт";
        ...
        en["FM_Cloud_RegisterButton"] = "Sign up";
        ru["FM_Cloud_LoginFailed"] = "Не удалось войти: {0}";
        en["FM_Cloud_LoginFailed"] = "Sign-in failed: {0}";
        ru["FM_Cloud_RegisterFailed"] = "Не удалось зарегистрироваться: {0}";
        en["FM_Cloud_RegisterFailed"] = "Sign-up failed: {0}";
        ru["FM_Cloud_WizardTitle"] = "Создать облачную базу";
        en["FM_Cloud_WizardTitle"] = "Create cloud database";
        ...
        en["FM_Cloud_WizardInvitePlaceholder"] = "smartcon-cloud:subscribe:…";
        ru["FM_Cloud_WizardInviteInvalid"] = "Строка приглашения не распознана. Скопируйте её целиком — она начинается с smartcon-cloud:subscribe:.";
        en["FM_Cloud_WizardInviteInvalid"] = "The invitation string was not recognized. Copy it in full — it starts with smartcon-cloud:subscribe:.";
        ru["FM_Cloud_WizardOk"] = "Продолжить";
        en["FM_Cloud_WizardOk"] = "Continue";
        ru["FM_Connect_ModeLocal"] = "Локальную базу из папки";
        en["FM_Connect_ModeLocal"] = "A local database from a folder";
        ru["FM_Connect_ModeCloud"] = "Облачную базу по строке приглашения";
        en["FM_Connect_ModeCloud"] = "A cloud database by invitation string";
        ru["FM_Connect_FolderLabel"] = "Папка базы данных";
        en["FM_Connect_FolderLabel"] = "Database folder";
        ru["FM_Connect_Browse"] = "Выбрать папку";
        en["FM_Connect_Browse"] = "Choose folder";
        ru["FM_Connect_Ok"] = "Подключить";
        en["FM_Connect_Ok"] = "Connect";
        ru["FM_Cloud_UnpublishCommand"] = "Снять с публикации";
        en["FM_Cloud_UnpublishCommand"] = "Unpublish";
        ru["FM_Cloud_UnpublishTooltip"] = "Удалить каталог с сервера: подписчики потеряют обновления, локальная база останется обычной";
        en["FM_Cloud_UnpublishTooltip"] = "Remove the catalog from the server: subscribers lose updates, the local database stays as a regular one";
        ru["FM_Cloud_UnpublishTitle"] = "Снять с публикации";
        en["FM_Cloud_UnpublishTitle"] = "Unpublish";
        ru["FM_Cloud_UnpublishBody"] = "Каталог «{1}» будет удалён с сервера: подписчики при следующем обновлении увидят, что база снята с публикации, и их копии перестанут обновляться.\r\n\r\nЛокальная база «{0}» останется и станет обычной (не облачной).\r\n\r\nСнять с публикации?";
        en["FM_Cloud_UnpublishBody"] = "Catalog '{1}' will be removed from the server: on their next update subscribers will see the database is unpublished and their copies will stop updating.\r\n\r\nThe local database '{0}' stays and becomes a regular (non-cloud) one.\r\n\r\nUnpublish?";
        ru["FM_Cloud_UnpublishDone"] = "База «{0}» снята с публикации. Локальная база осталась — теперь она обычная.";
        en["FM_Cloud_UnpublishDone"] = "Database '{0}' unpublished. The local database stays — it is a regular one now.";
        ru["FM_Cloud_CatalogGone"] = "Каталог «{1}» снят с публикации автором — обновления недоступны; база «{0}» переведена в обычную локальную";
        en["FM_Cloud_CatalogGone"] = "Catalog '{1}' was unpublished by its author — updates are unavailable; database '{0}' is now a regular local one";
        ru["FM_Cloud_DeletePublishedTitle"] = "База опубликована в облаке";
        en["FM_Cloud_DeletePublishedTitle"] = "The database is published to the cloud";
        ru["FM_Cloud_DeletePublishedBody"] = "База «{0}» опубликована как каталог «{1}». При удалении локальной базы она будет автоматически снята с публикации — подписчики потеряют обновления.\r\n\r\nПродолжить удаление?";
        en["FM_Cloud_DeletePublishedBody"] = "Database '{0}' is published as catalog '{1}'. Deleting the local database will automatically unpublish it — subscribers will lose updates.\r\n\r\nContinue with deletion?";
        ru["FM_Cloud_DeleteUnpublishFailedTitle"] = "Не удалось снять базу с публикации";
        en["FM_Cloud_DeleteUnpublishFailedTitle"] = "Failed to unpublish the database";
        ru["FM_Cloud_DeleteUnpublishFailedBody"] = "{0}\r\n\r\nКаталог останется на сервере. Всё равно удалить локальную базу?";
        en["FM_Cloud_DeleteUnpublishFailedBody"] = "{0}\r\n\r\nThe catalog will remain on the server. Delete the local database anyway?";
        ru["FM_Cloud_WizardCreated"] = "Облачная база «{0}» создана (каталог {1}). Импортируйте семейства, затем опубликуйте их командой «Опубликовать изменения».";
        en["FM_Cloud_WizardCreated"] = "Cloud database '{0}' created (catalog {1}). Import families, then publish them with the 'Publish changes' command.";
        ru["FM_Cloud_WizardSubscribed"] = "Подключено к каталогу «{0}»: получено {1} семейств.";
        en["FM_Cloud_WizardSubscribed"] = "Connected to catalog '{0}': {1} families received.";
        ru["FM_Cloud_PublishCommand"] = "Опубликовать изменения";
        en["FM_Cloud_PublishCommand"] = "Publish changes";
        ru["FM_Cloud_PublishTooltip"] = "Отправить изменения базы на сервер (сначала подтягиваются чужие публикации)";
        en["FM_Cloud_PublishTooltip"] = "Push database changes to the server (remote publications are pulled first)";
        ru["FM_Cloud_PublishTitle"] = "Публикация в облако";
        en["FM_Cloud_PublishTitle"] = "Publishing to the cloud";
        ru["FM_Cloud_PublishDone"] = "Опубликовано #{0}: {1} семейств в каталоге, новых файлов загружено: {2}.";
        en["FM_Cloud_PublishDone"] = "Published #{0}: {1} items in the catalog, {2} new files uploaded.";
        ru["FM_Cloud_PublishFailed"] = "Публикация не выполнена: {0}";
        en["FM_Cloud_PublishFailed"] = "Publish failed: {0}";
        ru["FM_Cloud_PublishQuarantinedTitle"] = "Семейства без категории";
        en["FM_Cloud_PublishQuarantinedTitle"] = "Families without category";
        ru["FM_Cloud_PublishQuarantinedBody"] = "Семейства в зоне «Без категории» не будут опубликованы — валидация параметров привязана к категориям, и подписчик не должен получать непроверенный контент:\r\n{0}\r\n\r\nОпубликовать остальные ({1})?";
        en["FM_Cloud_PublishQuarantinedBody"] = "Families in the 'No category' zone will NOT be published — parameter validation is category-bound and subscribers must not receive unchecked content:\r\n{0}\r\n\r\nPublish the rest ({1})?";
        ru["FM_Cloud_CopyInvite"] = "Скопировать приглашение";
        en["FM_Cloud_CopyInvite"] = "Copy invitation";
        ru["FM_Cloud_InviteCopied"] = "Приглашение скопировано в буфер обмена";
        en["FM_Cloud_InviteCopied"] = "Invitation copied to the clipboard";
        ru["FM_Cloud_UpdateAvailableBadge"] = "Доступны обновления из облака";
        en["FM_Cloud_UpdateAvailableBadge"] = "Cloud updates available";
        ru["FM_Cloud_RefreshBadgeSuffix"] = "\r\nДоступны обновления из облака — нажмите для загрузки";
        en["FM_Cloud_RefreshBadgeSuffix"] = "\r\nCloud updates available — click to pull";
        ru["FM_Cloud_PullTitle"] = "Обновление из облака";
        en["FM_Cloud_PullTitle"] = "Updating from the cloud";
        ru["FM_Cloud_PullDone"] = "Обновлено до публикации #{0}: {1}.";
        en["FM_Cloud_PullDone"] = "Updated to publication #{0}: {1}.";
        ru["FM_Cloud_DeltaAdded"] = "добавлено {0}";
        en["FM_Cloud_DeltaAdded"] = "{0} added";
        ru["FM_Cloud_DeltaUpdated"] = "обновлено {0}";
        en["FM_Cloud_DeltaUpdated"] = "{0} updated";
        ru["FM_Cloud_DeltaRemoved"] = "удалено {0}";
        en["FM_Cloud_DeltaRemoved"] = "{0} removed";
        ru["FM_Cloud_DeltaNone"] = "изменения в настройках каталога";
        en["FM_Cloud_DeltaNone"] = "catalog settings changes";
        ru["FM_Cloud_UpToDate"] = "База актуальна (публикация #{0})";
        en["FM_Cloud_UpToDate"] = "Database is up to date (publication #{0})";
        ru["FM_Cloud_PullFailed"] = "Обновление не выполнено: {0}";
        en["FM_Cloud_PullFailed"] = "Update failed: {0}";
        ru["FM_Cloud_StageBuildManifest"] = "Подготовка манифеста";
        en["FM_Cloud_StageBuildManifest"] = "Building manifest";
        ru["FM_Cloud_StageUpload"] = "Загрузка файлов на сервер";
        en["FM_Cloud_StageUpload"] = "Uploading files";
        ru["FM_Cloud_StageDownload"] = "Загрузка объектов";
        en["FM_Cloud_StageDownload"] = "Downloading objects";
        ru["FM_Cloud_StageApply"] = "Применение манифеста";
        en["FM_Cloud_StageApply"] = "Applying manifest";
        ru["FM_Cloud_ProgressFormat"] = "{0}: {1} из {2}";
        en["FM_Cloud_ProgressFormat"] = "{0}: {1} of {2}";
        ru["FM_Cloud_PublishedIconTooltip"] = "Облачная база — публикуется на сервер";
        en["FM_Cloud_PublishedIconTooltip"] = "Cloud database — published to the server";
        ru["FM_Cloud_SubscribedIconTooltip"] = "Облачная база — подписка (только чтение)";
        en["FM_Cloud_SubscribedIconTooltip"] = "Cloud database — subscription (read-only)";
        ru["FM_Cloud_Cancelled"] = "Операция отменена";
        en["FM_Cloud_Cancelled"] = "Operation cancelled";
        ru["FM_Cloud_OperationFailedTitle"] = "Облачная операция";
        en["FM_Cloud_OperationFailedTitle"] = "Cloud operation";
    }
}
