...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> Ru = new()
    {
        ...
        ["PM_Col_Index"] = "№",
        ["PM_Col_Field"] = "Поле",
        ["PM_Col_ParseRule"] = "Правило парсинга",
        ["PM_Col_Value"] = "Значение",
        ["PM_Col_Status"] = "✓",
        ["PM_Col_ValidationCheck"] = "Проверка",
        ["PM_Col_SourceValue"] = "Исходное",
        ["PM_Col_TargetValue"] = "При экспорте",
        ["PM_Title_Settings"] = "Настройки экспорта",
        ["PM_Title_Progress"] = "Экспорт проекта",
        ["PM_Title_FieldLibrary"] = "Библиотека полей",
        ["PM_Title_AllowedValues"] = "Допустимые значения",
        ["PM_Title_ParseRule"] = "Правило парсинга",
        ["PM_Result_Success"] = "Проект успешно перемещён в зону Shared.",
        ["PM_Result_Failed"] = "Ошибка экспорта: {0}",
        ["PM_Result_NoSettings"] = "Сначала настройте параметры экспорта через кнопку Settings.",
        ["PM_Result_InvalidName"] = "Имя файла не соответствует шаблону.",
        ...
        ["PM_NamingTemplate"] = "Шаблон имени файла",
        ["PM_Blocks"] = "Блоки",
        ["PM_AddBlock"] = "+ Блок",
        ["PM_RemoveBlock"] = "- Блок",
        ["PM_FieldLibrary"] = "Библиотека полей...",
        ["PM_ExportMappings"] = "Маппинг экспорта",
        ["PM_AddMapping"] = "+ Маппинг",
        ["PM_RemoveMapping"] = "- Маппинг",
        ["PM_Preview"] = "Предпросмотр",
        ["PM_CurrentName"] = "Текущее:",
        ["PM_SharedName"] = "Shared:",
        ["PM_Col_FieldName"] = "Имя поля",
        ["PM_Col_DisplayName"] = "Отображение",
        ["PM_Col_Description"] = "Описание",
        ["PM_Col_Validation"] = "Валидация",
        ["PM_Col_Min"] = "Мин",
        ["PM_Col_Max"] = "Макс",
        ["PM_AllowedValuesButton"] = "Допустимые значения...",
        ["PM_DuplicateField"] = "Дублировать",
        ["PM_ValidationMode"] = "Режим валидации:",
        ["PM_MinLength"] = "Мин. длина:",
        ["PM_MaxLength"] = "Макс. длина:",
        ["PM_AddValue"] = "+ Добавить",
        ["PM_RemoveValue"] = "- Удалить",
        ["PM_ParseMode"] = "Режим:",
        ["PM_Delimiter"] = "Разделитель:",
        ["PM_SegmentIndex"] = "Сегмент:",
        ["PM_CharCount"] = "Кол-во симв.:",
        ["PM_OpenMarker"] = "Откр.:",
        ["PM_CloseMarker"] = "Закр.:",
        ["PM_Marker"] = "Маркер:",
        ["PM_FileName"] = "Файл:",
        ["PM_Result"] = "Результат:",
        ["PM_Remaining"] = "Остаток:",
        ["PM_ValidField"] = "✓",
        ["PM_InvalidField"] = "✗",

        ["PM_ValMode_None"] = "Любое значение",
        ["PM_ValMode_None_Desc"] = "Без ограничений: поле принимает любое значение",
        ["PM_ValMode_List"] = "Только из списка",
        ["PM_ValMode_List_Desc"] = "Значение должно совпадать с одним из допустимых значений",
        ["PM_ValMode_Length"] = "По длине",
        ["PM_ValMode_Length_Desc"] = "Ограничение только на минимальную и максимальную длину текста",
        ["PM_ValMode_Both"] = "Список + длина",
        ["PM_ValMode_Both_Desc"] = "Значение должно быть из списка и соответствовать ограничениям длины",

        ["PM_ParseMode_Delimiter"] = "По разделителю",
        ["PM_ParseMode_Delimiter_Desc"] = "Разбивает текст по разделителю и берёт указанный сегмент (нумерация с 0)",
        ["PM_ParseMode_FixedWidth"] = "Фиксированная ширина",
        ["PM_ParseMode_FixedWidth_Desc"] = "Берёт заданное количество символов от начала",
        ["PM_ParseMode_Between"] = "Между маркерами",
        ["PM_ParseMode_Between_Desc"] = "Извлекает текст между открывающим и закрывающим маркерами",
        ["PM_ParseMode_After"] = "После маркера",
        ["PM_ParseMode_After_Desc"] = "Берёт весь текст после указанного маркера",
        ["PM_ParseMode_Remainder"] = "Остаток",
        ["PM_ParseMode_Remainder_Desc"] = "Берёт весь оставшийся текст после предыдущих блоков",
    };
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["PM_Col_Index"] = "#",
        ["PM_Col_Field"] = "Field",
        ["PM_Col_ParseRule"] = "Parse Rule",
        ["PM_Col_Value"] = "Value",
        ["PM_Col_Status"] = "✓",
        ["PM_Col_ValidationCheck"] = "Check",
        ["PM_Col_SourceValue"] = "Source",
        ["PM_Col_TargetValue"] = "Export",
        ["PM_Title_Settings"] = "Export Settings",
        ["PM_Title_Progress"] = "Exporting Project",
        ["PM_Title_FieldLibrary"] = "Field Library",
        ["PM_Title_AllowedValues"] = "Allowed Values",
        ["PM_Title_ParseRule"] = "Parse Rule",
        ["PM_Result_Success"] = "Project exported successfully.",
        ["PM_Result_Failed"] = "Export failed: {0}",
        ["PM_Result_NoSettings"] = "Configure export settings first via the Settings button.",
        ["PM_Result_InvalidName"] = "File name does not match template.",
        ...
        ["PM_NamingTemplate"] = "File Name Template",
        ["PM_Blocks"] = "Blocks",
        ["PM_AddBlock"] = "+ Block",
        ["PM_RemoveBlock"] = "- Block",
        ["PM_FieldLibrary"] = "Field Library...",
        ["PM_ExportMappings"] = "Export Mapping",
        ["PM_AddMapping"] = "+ Mapping",
        ["PM_RemoveMapping"] = "- Mapping",
        ["PM_Preview"] = "Preview",
        ["PM_CurrentName"] = "Current:",
        ["PM_SharedName"] = "Shared:",
        ["PM_Col_FieldName"] = "Field Name",
        ["PM_Col_DisplayName"] = "Display Name",
        ["PM_Col_Description"] = "Description",
        ["PM_Col_Validation"] = "Validation",
        ["PM_Col_Min"] = "Min",
        ["PM_Col_Max"] = "Max",
        ["PM_AllowedValuesButton"] = "Allowed Values...",
        ["PM_DuplicateField"] = "Duplicate",
        ["PM_ValidationMode"] = "Validation mode:",
        ["PM_MinLength"] = "Min length:",
        ["PM_MaxLength"] = "Max length:",
        ["PM_AddValue"] = "+ Add",
        ["PM_RemoveValue"] = "- Remove",
        ["PM_ParseMode"] = "Mode:",
        ["PM_Delimiter"] = "Delimiter:",
        ["PM_SegmentIndex"] = "Segment:",
        ["PM_CharCount"] = "Char count:",
        ["PM_OpenMarker"] = "Open:",
        ["PM_CloseMarker"] = "Close:",
        ["PM_Marker"] = "Marker:",
        ["PM_FileName"] = "File:",
        ["PM_Result"] = "Result:",
        ["PM_Remaining"] = "Remaining:",
        ["PM_ValidField"] = "✓",
        ["PM_InvalidField"] = "✗",

        ["PM_ValMode_None"] = "Any value",
        ["PM_ValMode_None_Desc"] = "No restrictions: field accepts any value",
        ["PM_ValMode_List"] = "From list only",
        ["PM_ValMode_List_Desc"] = "Value must match one of the allowed values",
        ["PM_ValMode_Length"] = "By length",
        ["PM_ValMode_Length_Desc"] = "Only minimum and maximum text length constraints",
        ["PM_ValMode_Both"] = "List + length",
        ["PM_ValMode_Both_Desc"] = "Value must be from the list and satisfy length constraints",

        ["PM_ParseMode_Delimiter"] = "By delimiter",
        ["PM_ParseMode_Delimiter_Desc"] = "Splits text by delimiter and takes the specified segment (0-based)",
        ["PM_ParseMode_FixedWidth"] = "Fixed width",
        ["PM_ParseMode_FixedWidth_Desc"] = "Takes a fixed number of characters from the start",
        ["PM_ParseMode_Between"] = "Between markers",
        ["PM_ParseMode_Between_Desc"] = "Extracts text between opening and closing markers",
        ["PM_ParseMode_After"] = "After marker",
        ["PM_ParseMode_After_Desc"] = "Takes all text after the specified marker",
        ["PM_ParseMode_Remainder"] = "Remainder",
        ["PM_ParseMode_Remainder_Desc"] = "Takes all remaining text after previous blocks",
    };
