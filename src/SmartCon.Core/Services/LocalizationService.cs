...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> Ru = new()
    {
        ...
        ["Tip_FittingCtc"] = "Изменить типы коннекторов фитинга",
        ["Tip_SelectFitting"] = "Выберите фитинг для соединения",
        ["Tip_InsertFitting"] = "Вставить выбранный фитинг (примерка)",
        ["Tip_ReducerCtc"] = "Изменить типы коннекторов переходника",
        ...
        ["Status_CtcReducerUpdated"] = "CTC переходника обновлён — переориентирован",
        ["Status_CtcFittingUpdated"] = "CTC фитинга обновлён — переориентирован",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Status_CtcReducerUpdated"] = "Reducer CTC updated — reoriented",
        ["Status_CtcFittingUpdated"] = "Fitting CTC updated — reoriented",
