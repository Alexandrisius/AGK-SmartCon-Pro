...
public static class StringLocalization
{
    ...
    private static ResourceDictionary BuildRu()
    {
        ...
        d[Keys.FM_Properties] = "Свойства";
        d[Keys.FM_Props_SelectImage] = "Выберите изображение";
        d[Keys.FM_Props_AddFile] = "Выберите файл";
        d[Keys.FM_Tab_General] = "Общие";
        d[Keys.FM_Tab_Content] = "Контент";
        d[Keys.FM_Tab_Attributes] = "Атрибуты";
        d[Keys.FM_Tab_3DView] = "3D Просмотр";
        d[Keys.FM_Props_Manufacturer] = "Производитель";
        d[Keys.FM_Props_Version] = "Версия";
        d[Keys.FM_Props_Size] = "Размер";
        d[Keys.FM_Props_Created] = "Создано";
        d[Keys.FM_Props_Updated] = "Обновлено";
        d[Keys.FM_Props_NoAvatar] = "Нет изображения";
        d[Keys.FM_Props_ChangeImage] = "Сменить";
        d[Keys.FM_Props_RemoveImage] = "Удалить";
        d[Keys.FM_Props_Images] = "Изображения";
        d[Keys.FM_Props_Videos] = "Видео";
        d[Keys.FM_Props_Documents] = "Документы";
        d[Keys.FM_Props_LookupTables] = "Таблицы поиска (CSV)";
        d[Keys.FM_Props_Spreadsheets] = "Электронные таблицы (XLS)";
        d[Keys.FM_Props_Models3D] = "3D Модели";
        d[Keys.FM_Props_Other] = "Прочие файлы";
        d[Keys.FM_Props_Open] = "Открыть";
        d[Keys.FM_Props_Delete] = "Удалить";
        d[Keys.FM_Props_SetPrimary] = "Сделать главной";
        d[Keys.FM_Props_Add] = "+ Добавить";
        d[Keys.FM_Props_NoAttributes] = "Атрибуты не извлечены";
        d[Keys.FM_Props_NoAttributesDesc] = "Для извлечения атрибутов семейство будет временно загружено в Revit";
        d[Keys.FM_Props_PresetCategory] = "Категория: {0}";
        d[Keys.FM_Props_NoPresets] = "Нет пресетов для этой категории";
        d[Keys.FM_Props_3DComingSoon] = "3D-просмотр модели (GLB) — в разработке";
        d[Keys.FM_Props_3DDesc] = "Здесь будет интерактивный 3D-просмотр модели семейства. Вы сможете вращать, масштабировать и изучать геометрию перед загрузкой в проект.";
        d[Keys.FM_Props_FileInfo] = "Информация о файле";
        d[Keys.FM_Props_Title] = "Свойства семейства";
        d[Keys.FM_Props_NoAssets] = "Нет файлов";
        d[Keys.FM_Props_ConfigurePreset] = "Настроить пресет...";
        d[Keys.FM_Props_ExtractAttributes] = "Извлечь атрибуты";
        d[Keys.FM_PE_Title] = "Редактор пресета атрибутов";
        d[Keys.FM_PE_ParameterName] = "Имя параметра";
        d[Keys.FM_PE_DisplayName] = "Отображаемое имя";
        d[Keys.FM_PE_AddParameter] = "+ Добавить параметр";
    ...
    private static ResourceDictionary BuildEn()
    {
        ...
        d[Keys.FM_Properties] = "Properties";
        d[Keys.FM_Props_SelectImage] = "Select image";
        d[Keys.FM_Props_AddFile] = "Select file";
        d[Keys.FM_Tab_General] = "General";
        d[Keys.FM_Tab_Content] = "Content";
        d[Keys.FM_Tab_Attributes] = "Attributes";
        d[Keys.FM_Tab_3DView] = "3D Preview";
        d[Keys.FM_Props_Manufacturer] = "Manufacturer";
        d[Keys.FM_Props_Version] = "Version";
        d[Keys.FM_Props_Size] = "Size";
        d[Keys.FM_Props_Created] = "Created";
        d[Keys.FM_Props_Updated] = "Updated";
        d[Keys.FM_Props_NoAvatar] = "No image";
        d[Keys.FM_Props_ChangeImage] = "Change";
        d[Keys.FM_Props_RemoveImage] = "Remove";
        d[Keys.FM_Props_Images] = "Images";
        d[Keys.FM_Props_Videos] = "Videos";
        d[Keys.FM_Props_Documents] = "Documents";
        d[Keys.FM_Props_LookupTables] = "Lookup Tables (CSV)";
        d[Keys.FM_Props_Spreadsheets] = "Spreadsheets (XLS)";
        d[Keys.FM_Props_Models3D] = "3D Models";
        d[Keys.FM_Props_Other] = "Other Files";
        d[Keys.FM_Props_Open] = "Open";
        d[Keys.FM_Props_Delete] = "Delete";
        d[Keys.FM_Props_SetPrimary] = "Set as primary";
        d[Keys.FM_Props_Add] = "+ Add";
        d[Keys.FM_Props_NoAttributes] = "No attributes extracted";
        d[Keys.FM_Props_NoAttributesDesc] = "To extract attributes, the family will be temporarily loaded into Revit";
        d[Keys.FM_Props_PresetCategory] = "Category: {0}";
        d[Keys.FM_Props_NoPresets] = "No presets for this category";
        d[Keys.FM_Props_3DComingSoon] = "3D model preview (GLB) — coming soon";
        d[Keys.FM_Props_3DDesc] = "Interactive 3D preview of the family model will be available here. You will be able to rotate, zoom, and explore geometry before loading into the project.";
        d[Keys.FM_Props_FileInfo] = "File Information";
        d[Keys.FM_Props_Title] = "Family Properties";
        d[Keys.FM_Props_NoAssets] = "No files";
        d[Keys.FM_Props_ConfigurePreset] = "Configure preset...";
        d[Keys.FM_Props_ExtractAttributes] = "Extract attributes";
        d[Keys.FM_PE_Title] = "Attribute Preset Editor";
        d[Keys.FM_PE_ParameterName] = "Parameter Name";
        d[Keys.FM_PE_DisplayName] = "Display Name";
