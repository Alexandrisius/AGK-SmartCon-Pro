...
public static class StringLocalization
{
    ...
    public static class Keys
    {
        ...
        public const string FM_PlaceType_DotLoadPlace = "FM_PlaceType_DotLoadPlace";
        public const string FM_PlaceType_DotUpdatePlace = "FM_PlaceType_DotUpdatePlace";
        ...
        public const string FM_HashRecalc_PurgeSwitchedActive = "FM_HashRecalc_PurgeSwitchedActive";
        public const string FM_HashRecalc_PurgeResetLinks = "FM_HashRecalc_PurgeResetLinks";
        public const string FM_HashRecalc_PurgeResetLinks_Item = "FM_HashRecalc_PurgeResetLinks_Item";
        public const string FM_HashRecalc_PurgeResetLinksNote = "FM_HashRecalc_PurgeResetLinksNote";
        public const string FM_PBase_CleanupMissingRecords = "FM_PBase_CleanupMissingRecords";
        public const string FM_PBase_CleanupMissingRecordsTooltip = "FM_PBase_CleanupMissingRecordsTooltip";
        public const string FM_Cleanup_Title = "FM_Cleanup_Title";
        public const string FM_Cleanup_Warning = "FM_Cleanup_Warning";
        public const string FM_Cleanup_NothingFound = "FM_Cleanup_NothingFound";
        public const string FM_Cleanup_FoundCount = "FM_Cleanup_FoundCount";
        public const string FM_Cleanup_Searching = "FM_Cleanup_Searching";
        public const string FM_Cleanup_CheckDisk = "FM_Cleanup_CheckDisk";
        public const string FM_Cleanup_CheckDiskTooltip = "FM_Cleanup_CheckDiskTooltip";
        public const string FM_Cleanup_ScanProgress = "FM_Cleanup_ScanProgress";
        public const string FM_Cleanup_ScanCancelled = "FM_Cleanup_ScanCancelled";
        public const string FM_Cleanup_ScanCancelledEmpty = "FM_Cleanup_ScanCancelledEmpty";
        public const string FM_Cleanup_Stopping = "FM_Cleanup_Stopping";
        public const string FM_Cleanup_SelectAll = "FM_Cleanup_SelectAll";
        public const string FM_Cleanup_ClearSelection = "FM_Cleanup_ClearSelection";
        public const string FM_Cleanup_DeleteSelected = "FM_Cleanup_DeleteSelected";
        public const string FM_Cleanup_DeleteAll = "FM_Cleanup_DeleteAll";
        public const string FM_Cleanup_ConfirmTitle = "FM_Cleanup_ConfirmTitle";
        public const string FM_Cleanup_ConfirmBody = "FM_Cleanup_ConfirmBody";
        public const string FM_Cleanup_Close = "FM_Cleanup_Close";
        public const string FM_Cleanup_ReasonMarked = "FM_Cleanup_ReasonMarked";
        public const string FM_Cleanup_ReasonFileMissing = "FM_Cleanup_ReasonFileMissing";
        public const string FM_Cleanup_ColItem = "FM_Cleanup_ColItem";
        public const string FM_Cleanup_ColVersion = "FM_Cleanup_ColVersion";
        public const string FM_Cleanup_ColRevit = "FM_Cleanup_ColRevit";
        public const string FM_Cleanup_ColFile = "FM_Cleanup_ColFile";
        public const string FM_Cleanup_ColReason = "FM_Cleanup_ColReason";
        public const string FM_Badge_RoutingPhantom_Short = "FM_Badge_RoutingPhantom_Short";
        public const string FM_Badge_RoutingPhantom_Hint = "FM_Badge_RoutingPhantom_Hint";
        public const string FM_Badge_RoutingPhantom_Category = "FM_Badge_RoutingPhantom_Category";
        public const string FM_Notice_RoutingPhantom_Title = "FM_Notice_RoutingPhantom_Title";
        public const string FM_Notice_RoutingPhantom_Guidance = "FM_Notice_RoutingPhantom_Guidance";
        public const string FM_Notice_CategoryRouting_Title = "FM_Notice_CategoryRouting_Title";
        public const string FM_Notice_CategoryRouting_Guidance = "FM_Notice_CategoryRouting_Guidance";
        ...
        public const string FM_DbUpdate_Stopping = "FM_DbUpdate_Stopping";
        public const string FM_DbUpdate_SummaryUpdated = "FM_DbUpdate_SummaryUpdated";
        public const string FM_DbUpdate_SummaryFailed = "FM_DbUpdate_SummaryFailed";
        public const string FM_DbUpdate_SummaryNewerRevit = "FM_DbUpdate_SummaryNewerRevit";
        public const string FM_DbUpdate_SummaryMissing = "FM_DbUpdate_SummaryMissing";
        public const string FM_DbUpdate_SummaryCancelled = "FM_DbUpdate_SummaryCancelled";
        public const string FM_DbUpdate_Cancel = "FM_DbUpdate_Cancel";
        public const string FM_DbUpdate_Close = "FM_DbUpdate_Close";
        public const string FM_BatchImport_StatusError = "FM_BatchImport_StatusError";
        public const string FM_Gate_Tooltip_NotChecked = "FM_Gate_Tooltip_NotChecked";
        public const string FM_Gate_Tooltip_Checking = "FM_Gate_Tooltip_Checking";
        public const string FM_Gate_Tooltip_Passed = "FM_Gate_Tooltip_Passed";
        public const string FM_Gate_Tooltip_PassedRules = "FM_Gate_Tooltip_PassedRules";
        public const string FM_Gate_Tooltip_Warning = "FM_Gate_Tooltip_Warning";
        ...
        public const string FM_ValidationReport_HealthSection = "FM_ValidationReport_HealthSection";
        public const string FM_ValidationReport_ViolationsSection = "FM_ValidationReport_ViolationsSection";
        public const string FM_ValidationReport_SummaryPassedWithWarnings = "FM_ValidationReport_SummaryPassedWithWarnings";
        public const string FM_HealthReport_Copy = "FM_HealthReport_Copy";
        public const string FM_HealthReport_CopyTooltip = "FM_HealthReport_CopyTooltip";
        public const string FM_HealthReport_ErrorLabel = "FM_HealthReport_ErrorLabel";
        public const string FM_HealthReport_WarningLabel = "FM_HealthReport_WarningLabel";
        public const string FM_ValidationReport_ColType = "FM_ValidationReport_ColType";
        public const string FM_ValidationReport_ColAttribute = "FM_ValidationReport_ColAttribute";
        public const string FM_ValidationReport_ColCheck = "FM_ValidationReport_ColCheck";
        public const string FM_ValidationReport_ColExpected = "FM_ValidationReport_ColExpected";
        public const string FM_ValidationReport_ColActual = "FM_ValidationReport_ColActual";
        public const string FM_ValidationReport_EmptyValue = "FM_ValidationReport_EmptyValue";
        public const string FM_ValidationReport_SummaryPassed = "FM_ValidationReport_SummaryPassed";
        public const string FM_ValidationReport_SummaryPassedRules = "FM_ValidationReport_SummaryPassedRules";
        public const string FM_ValidationReport_SummaryFailed = "FM_ValidationReport_SummaryFailed";
        ...
        public const string FM_RuleOp_Equals = "FM_RuleOp_Equals";
        public const string FM_RuleOp_NotEquals = "FM_RuleOp_NotEquals";
        public const string FM_RuleOp_Contains = "FM_RuleOp_Contains";
        public const string FM_RuleOp_NotContains = "FM_RuleOp_NotContains";
        ...
        public const string FM_CTE_ImportedAssignment = "FM_CTE_ImportedAssignment";
        public const string FM_CTE_ContextMenu_AssignmentRules = "FM_CTE_ContextMenu_AssignmentRules";
        public const string FM_AssignEditor_Title = "FM_AssignEditor_Title";
        public const string FM_AssignEditor_Subtitle = "FM_AssignEditor_Subtitle";
        public const string FM_AssignEditor_Group = "FM_AssignEditor_Group";
        public const string FM_AssignEditor_AddGroup = "FM_AssignEditor_AddGroup";
        public const string FM_AssignEditor_EmptyGroups = "FM_AssignEditor_EmptyGroups";
        public const string FM_AssignEditor_AddCondition = "FM_AssignEditor_AddCondition";
        public const string FM_AssignEditor_SourceAttribute = "FM_AssignEditor_SourceAttribute";
        public const string FM_AssignEditor_SourceSystem = "FM_AssignEditor_SourceSystem";
        public const string FM_AssignEditor_Field_RevitCategory = "FM_AssignEditor_Field_RevitCategory";
        public const string FM_AssignEditor_Field_PartType = "FM_AssignEditor_Field_PartType";
        ...
        public const string FM_AdvSearch_Title = "FM_AdvSearch_Title";
        public const string FM_AdvSearch_Subtitle = "FM_AdvSearch_Subtitle";
        public const string FM_AdvSearch_Category = "FM_AdvSearch_Category";
        public const string FM_AdvSearch_AllCategories = "FM_AdvSearch_AllCategories";
        public const string FM_AdvSearch_ColOperator = "FM_AdvSearch_ColOperator";
        public const string FM_AdvSearch_And = "FM_AdvSearch_And";
        public const string FM_AdvSearch_AddCondition = "FM_AdvSearch_AddCondition";
        public const string FM_AdvSearch_Empty = "FM_AdvSearch_Empty";
        public const string FM_AdvSearch_Apply = "FM_AdvSearch_Apply";
        public const string FM_AdvSearch_ApplyIncomplete = "FM_AdvSearch_ApplyIncomplete";
        public const string FM_AdvSearch_Reset = "FM_AdvSearch_Reset";
        public const string FM_SearchOp_HasValue = "FM_SearchOp_HasValue";
        public const string FM_SearchOp_IsEmpty = "FM_SearchOp_IsEmpty";
        public const string FM_AdvSearch_OpenTooltip = "FM_AdvSearch_OpenTooltip";
        public const string FM_AdvSearch_ActiveTooltipFormat = "FM_AdvSearch_ActiveTooltipFormat";
        public const string FM_AdvSearch_CategoryOnlyTooltip = "FM_AdvSearch_CategoryOnlyTooltip";
        public const string FM_AdvSearch_PickCategoryTooltip = "FM_AdvSearch_PickCategoryTooltip";
        public const string FM_AdvSearch_SuggestionsTooltip = "FM_AdvSearch_SuggestionsTooltip";
        public const string FM_AdvSearch_NoSuggestions = "FM_AdvSearch_NoSuggestions";
        public const string FM_NoResultsPlaceholder = "FM_NoResultsPlaceholder";
        public const string FM_EmptyCatalogPlaceholder = "FM_EmptyCatalogPlaceholder";
        public const string FM_ItemCountTooltipFormat = "FM_ItemCountTooltipFormat";
        ...
        public const string FM_AssignEditor_ErrorAttributeRequired = "FM_AssignEditor_ErrorAttributeRequired";
        ...
        public const string FM_RulesEditor_Cancel = "FM_RulesEditor_Cancel";
        public const string FM_RulesEditor_ColOperator = "FM_RulesEditor_ColOperator";
        public const string FM_RulesEditor_ColValue = "FM_RulesEditor_ColValue";
        public const string FM_RulesEditor_ColEnabled = "FM_RulesEditor_ColEnabled";
        public const string FM_RulesEditor_ErrorValueRequired = "FM_RulesEditor_ErrorValueRequired";
        public const string FM_RulesEditor_ErrorNumberRequired = "FM_RulesEditor_ErrorNumberRequired";
        public const string FM_RulesEditor_ErrorRangeRequired = "FM_RulesEditor_ErrorRangeRequired";
        public const string FM_RulesEditor_ErrorRangeOrder = "FM_RulesEditor_ErrorRangeOrder";
        public const string FM_Gate_CategoryBlocked_Banner = "FM_Gate_CategoryBlocked_Banner";
        public const string FM_Gate_CategoryBlockedNoData_Title = "FM_Gate_CategoryBlockedNoData_Title";
        public const string FM_Gate_CategoryBlockedNoData_Body = "FM_Gate_CategoryBlockedNoData_Body";
        ...
        public const string FM_StatusDetails_Title = "FM_StatusDetails_Title";
        public const string FM_StatusDetails_OpenValidationReport = "FM_StatusDetails_OpenValidationReport";
        public const string FM_Badge_ClickHint = "FM_Badge_ClickHint";
        public const string FM_Badge_Info_Tooltip = "FM_Badge_Info_Tooltip";
        public const string FM_Badge_Dependency_Tooltip = "FM_Badge_Dependency_Tooltip";
        public const string FM_Badge_Warning_Tooltip = "FM_Badge_Warning_Tooltip";
        public const string FM_Badge_Error_Tooltip = "FM_Badge_Error_Tooltip";
        public const string FM_Badge_OutdatedDeps_Short = "FM_Badge_OutdatedDeps_Short";
        public const string FM_Notice_CrossNameDuplicate_Title = "FM_Notice_CrossNameDuplicate_Title";
        public const string FM_Notice_OutdatedNested_Title = "FM_Notice_OutdatedNested_Title";
        public const string FM_Notice_DependencyBlock_Title = "FM_Notice_DependencyBlock_Title";
        public const string FM_Notice_FailedDependencies_Title = "FM_Notice_FailedDependencies_Title";
        public const string FM_Notice_DependencyOf_Title = "FM_Notice_DependencyOf_Title";
        public const string FM_Notice_MarkerResolved_Title = "FM_Notice_MarkerResolved_Title";
        public const string FM_Notice_Stale_Title = "FM_Notice_Stale_Title";
        public const string FM_Notice_OutdatedDependencies_Title = "FM_Notice_OutdatedDependencies_Title";
        public const string FM_Notice_DependencyReferenced_Title = "FM_Notice_DependencyReferenced_Title";
        public const string FM_Notice_CategoryStale_Title = "FM_Notice_CategoryStale_Title";
        public const string FM_Notice_DependencyBlock_Guidance = "FM_Notice_DependencyBlock_Guidance";
        public const string FM_Notice_FailedDeps_Guidance = "FM_Notice_FailedDeps_Guidance";
        public const string FM_Notice_OutdatedNested_Body = "FM_Notice_OutdatedNested_Body";
        ...
        public const string FM_PBase_OptionalBadgeTooltip = "FM_PBase_OptionalBadgeTooltip";
        ...
        public const string FM_Cloud_LoginPassword = "FM_Cloud_LoginPassword";
        ...
        public const string FM_Cloud_RegisterFailed = "FM_Cloud_RegisterFailed";
        public const string FM_Cloud_WizardTitle = "FM_Cloud_WizardTitle";
        public const string FM_Cloud_WizardModeCreate = "FM_Cloud_WizardModeCreate";
        public const string FM_Cloud_WizardModeSubscribe = "FM_Cloud_WizardModeSubscribe";
        public const string FM_Cloud_WizardNameLabel = "FM_Cloud_WizardNameLabel";
        public const string FM_Cloud_WizardNamePlaceholder = "FM_Cloud_WizardNamePlaceholder";
        public const string FM_Cloud_WizardInviteLabel = "FM_Cloud_WizardInviteLabel";
        public const string FM_Cloud_WizardInvitePlaceholder = "FM_Cloud_WizardInvitePlaceholder";
        public const string FM_Cloud_WizardInviteInvalid = "FM_Cloud_WizardInviteInvalid";
        public const string FM_Cloud_WizardOk = "FM_Cloud_WizardOk";
        ...
        public const string FM_Cloud_PublishTooltip = "FM_Cloud_PublishTooltip";
        ...
        public const string FM_Cloud_PullFailed = "FM_Cloud_PullFailed";
        public const string FM_Cloud_StageBuildManifest = "FM_Cloud_StageBuildManifest";
        public const string FM_Cloud_StageUpload = "FM_Cloud_StageUpload";
        public const string FM_Cloud_StageDownload = "FM_Cloud_StageDownload";
        public const string FM_Cloud_StageApply = "FM_Cloud_StageApply";
        public const string FM_Cloud_ProgressFormat = "FM_Cloud_ProgressFormat";
        public const string FM_Cloud_PublishedIconTooltip = "FM_Cloud_PublishedIconTooltip";
        public const string FM_Cloud_SubscribedIconTooltip = "FM_Cloud_SubscribedIconTooltip";
        public const string FM_Cloud_Cancelled = "FM_Cloud_Cancelled";
        public const string FM_Cloud_OperationFailedTitle = "FM_Cloud_OperationFailedTitle";
        ...
        public const string FM_PlaceSystemTypeManual = "FM_PlaceSystemTypeManual";
        public const string FM_ImportVersionGateTitle = "FM_ImportVersionGateTitle";
        public const string FM_ImportVersionGateBody = "FM_ImportVersionGateBody";
        public const string FM_ImportVersionGateItem = "FM_ImportVersionGateItem";
        ...
        public const string FM_Diff_Section_META = "FM_Diff_Section_META";
        public const string FM_Diff_Section_PARAMS = "FM_Diff_Section_PARAMS";
        public const string FM_Diff_Section_TYPES = "FM_Diff_Section_TYPES";
        public const string FM_Diff_Section_PHANTOM = "FM_Diff_Section_PHANTOM";
        public const string FM_Diff_Section_DEF = "FM_Diff_Section_DEF";
        public const string FM_Diff_Section_GEOM = "FM_Diff_Section_GEOM";
        public const string FM_Diff_Section_GEOM2D = "FM_Diff_Section_GEOM2D";
        public const string FM_Diff_Section_NESTED = "FM_Diff_Section_NESTED";
        public const string FM_Diff_Section_NONSHARED = "FM_Diff_Section_NONSHARED";
        public const string FM_Diff_Section_NESTEDHASH = "FM_Diff_Section_NESTEDHASH";
        public const string FM_Diff_Section_FACTS = "FM_Diff_Section_FACTS";
        public const string FM_Diff_Section_FLAGS = "FM_Diff_Section_FLAGS";
        public const string FM_Diff_Section_CONN = "FM_Diff_Section_CONN";
        public const string FM_Diff_Section_LOOKUP = "FM_Diff_Section_LOOKUP";
        public const string FM_Diff_Section_FAMKEY = "FM_Diff_Section_FAMKEY";
        public const string FM_Diff_Section_STRUCT = "FM_Diff_Section_STRUCT";
        public const string FM_Diff_Section_ROUTING = "FM_Diff_Section_ROUTING";
        public const string FM_Diff_Section_SEGMENTS = "FM_Diff_Section_SEGMENTS";
        public const string FM_Diff_Section_SUBTYPES = "FM_Diff_Section_SUBTYPES";
        public const string FM_Diff_Section_RAILING = "FM_Diff_Section_RAILING";
        ...
        public const string FM_Status_CategoryNoFamilies = "FM_Status_CategoryNoFamilies";
        public const string FM_Status_CategoryNoneLoaded = "FM_Status_CategoryNoneLoaded";
        public const string FM_Status_CategoryCheckResult = "FM_Status_CategoryCheckResult";
        public const string FM_Status_CheckError = "FM_Status_CheckError";
        public const string FM_Status_FamilyNotLoaded = "FM_Status_FamilyNotLoaded";
        public const string FM_Status_FamilyStaleReason = "FM_Status_FamilyStaleReason";
        public const string FM_Status_FamilyUpToDate = "FM_Status_FamilyUpToDate";
        public const string FM_Status_ModeOverwriteParams = "FM_Status_ModeOverwriteParams";
        public const string FM_Status_ModeKeepParams = "FM_Status_ModeKeepParams";
        public const string FM_Status_CategoryUpdateResult = "FM_Status_CategoryUpdateResult";
        public const string FM_Status_CategoryUpdateResultErrors = "FM_Status_CategoryUpdateResultErrors";
        public const string FM_Status_UpdateError = "FM_Status_UpdateError";
        public const string FM_Status_RuleCategoryNoItems = "FM_Status_RuleCategoryNoItems";
        public const string FM_Status_RuleCheckResult = "FM_Status_RuleCheckResult";
        public const string FM_Status_RuleNoDataSuffix = "FM_Status_RuleNoDataSuffix";
        public const string FM_Status_RuleCheckError = "FM_Status_RuleCheckError";
        public const string FM_Status_RuleViolations = "FM_Status_RuleViolations";
        public const string FM_Status_RuleNoAttributeData = "FM_Status_RuleNoAttributeData";
        public const string FM_Status_RuleNoneDefined = "FM_Status_RuleNoneDefined";
        public const string FM_Status_RulesPassed = "FM_Status_RulesPassed";
        ...
        public const string FM_Tab_Routing = "FM_Tab_Routing";
        public const string FM_Routing_Type = "FM_Routing_Type";
        public const string FM_Routing_PreferredJunction = "FM_Routing_PreferredJunction";
        ...
        public const string FM_Routing_Group_JunctionsTaps = "FM_Routing_Group_JunctionsTaps";
        public const string FM_Routing_InactiveJunction = "FM_Routing_InactiveJunction";
        public const string FM_Routing_Group_Crosses = "FM_Routing_Group_Crosses";
        public const string FM_Routing_Group_Transitions = "FM_Routing_Group_Transitions";
        public const string FM_Routing_Group_TransitionSingle = "FM_Routing_Group_TransitionSingle";
        public const string FM_Routing_Group_Unions = "FM_Routing_Group_Unions";
        public const string FM_Routing_Group_Flanges = "FM_Routing_Group_Flanges";
        public const string FM_Routing_Group_Caps = "FM_Routing_Group_Caps";
        public const string FM_Routing_Group_TransitionRectToRound = "FM_Routing_Group_TransitionRectToRound";
        public const string FM_Routing_Group_TransitionRectToOval = "FM_Routing_Group_TransitionRectToOval";
        public const string FM_Routing_Group_TransitionOvalToRound = "FM_Routing_Group_TransitionOvalToRound";
        public const string FM_Routing_Group_CrossesElectrical = "FM_Routing_Group_CrossesElectrical";
        public const string FM_Routing_Param_RectToRound = "FM_Routing_Param_RectToRound";
        public const string FM_Routing_Param_RectToOval = "FM_Routing_Param_RectToOval";
        public const string FM_Routing_Param_OvalToRound = "FM_Routing_Param_OvalToRound";
        public const string FM_Routing_Group_Bend = "FM_Routing_Group_Bend";
        public const string FM_Routing_Group_HorizontalBend = "FM_Routing_Group_HorizontalBend";
        public const string FM_Routing_Group_VerticalBendOuter = "FM_Routing_Group_VerticalBendOuter";
        public const string FM_Routing_Group_VerticalBendInner = "FM_Routing_Group_VerticalBendInner";
        public const string FM_Routing_Group_Takeoff = "FM_Routing_Group_Takeoff";
        ...
        public const string FM_Routing_PickPart = "FM_Routing_PickPart";
        public const string FM_Routing_ClearPart = "FM_Routing_ClearPart";
        public const string FM_Routing_MoveUp_Tip = "FM_Routing_MoveUp_Tip";
        public const string FM_Routing_MoveDown_Tip = "FM_Routing_MoveDown_Tip";
        public const string FM_Routing_RemoveRule_Tip = "FM_Routing_RemoveRule_Tip";
        public const string FM_Routing_PartNotInCatalog = "FM_Routing_PartNotInCatalog";
        public const string FM_Routing_NoCandidates = "FM_Routing_NoCandidates";
        public const string FM_Routing_Picker_Title = "FM_Routing_Picker_Title";
        ...
        public const string FM_Routing_InvalidSize = "FM_Routing_InvalidSize";
        ...
        public const string FM_SP_PathPlaceholder = "FM_SP_PathPlaceholder";
        public const string FM_SP_Search = "FM_SP_Search";
        public const string FM_SP_ColName = "FM_SP_ColName";
        public const string FM_SP_ColDescription = "FM_SP_ColDescription";
        public const string FM_SP_SelectAll = "FM_SP_SelectAll";
        public const string FM_SP_DeselectAll = "FM_SP_DeselectAll";
        public const string FM_SP_Add = "FM_SP_Add";
        public const string FM_SP_SelectedFormat = "FM_SP_SelectedFormat";
        public const string FM_SP_AlreadyExists = "FM_SP_AlreadyExists";
        public const string FM_SP_ParseError = "FM_SP_ParseError";
        public const string FM_SP_NoParams = "FM_SP_NoParams";
        public const string FM_SP_NothingSelected = "FM_SP_NothingSelected";
        public const string FM_SP_CachedFileMissing = "FM_SP_CachedFileMissing";
        public const string FM_SP_AllGroups = "FM_SP_AllGroups";
