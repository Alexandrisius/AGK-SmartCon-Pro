...
/// Revit 2019-2022: свойства <c>Category.BuiltInCategory</c> нет — нужен cast из <c>Id</c>.
/// Revit 2023+:     <c>Category.BuiltInCategory</c> возвращает корректный enum или INVALID
...
///
/// <para>Для R19/R22, где свойства нет, мы используем cast как fallback, но с try/catch —
