...
public sealed class RevitWindowFocusService : IWindowFocusService
{
    ...
    public void RestoreFocusAndRefreshUI()
    {
        ...
        {
            SmartConLogger.Warn($"WindowFocus: Failed to restore focus: {ex.Message} [Action: переключите фокус на окно Revit вручную; DockablePane останется работоспособной]");
        }
    }
}
